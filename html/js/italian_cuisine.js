$(function() { //ready
	...
	function drawGeoChart() {
		<!-- GEO CHART -->
		$.get("csv/italian_aggregate_countries.csv", function(csvString) {
	...
	function drawLineChart() {
		<!-- LINE CHART -->
		$.get("csv/italian_aggregate_years.csv", function(csvString) {
	...
	function drawBarChart() {
		<!-- BAR GRAPH -->
		// grab the CSV
		$.get("csv/italian_full_agg.csv", function(csvString) {
	...
	function drawBubbleChart() {
		<!-- BAR CHART -->
		$.get("csv/italian_full_agg_bubble.csv", function(csvString) {
	...
	function drawWordCloud() {
		readTextFile("csv/italian_full_agg_text.csv")
		//alert(text)

...
class DataBubbleChart:
    ...
    def aggregate_data(self, csv_to_proc, output_csv, head_count):
        ...
        csvout.writerow(["Country", "Positive", "Negative", "Neutral", "Total"])
        ...
        for data in sortedresult:
            ...
            if data[1]['country'] != "global":
                csvout.writerow([data[1]['country'], data[1]['positive'], data[1]['negative'], data[1]['neutral'], data[1]['total']])
            count += 1
            #print(data[1])
...
if __name__ == "__main__":
    ...
    output_csv = "/home/mangirish/BDAA/TwitterAnalysis/html/csv/mideast_full_agg_bubble.csv"
